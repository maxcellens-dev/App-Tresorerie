          ...
          {tab === 'help' && (
            <>
              ...
              <View style={styles.calcCard}>
                ...
                <Text style={styles.calcSub}>Le taux est mesuré PAR TRANCHES (la « fenêtre d’assiduité »), puis moyenné en pondérant chaque tranche par son nombre de JOURS : le doute s’accumule jour par jour, donc une semaine bien suivie efface le doute de ses jours, quoi qu’il arrive ailleurs. C’est le découpage — et le plafond de chaque tranche — qui empêche un seul achat de 2 000 € d’effacer trois semaines : il ne couvre que sa propre tranche. Dans chaque tranche, saisir jour après jour vaut preuve au même titre que les montants, mais pour la moitié du chemin au plus : l’assiduité prouve qu’on suit, pas qu’on a tout noté. Sans aucune vérification passée, rien n’est effacé : un point de départ jamais constaté ne se rattrape pas à coups de saisies.</Text>
                ...
                <Text style={styles.calcSub}>Si elle n’en avait saisi que la moitié, la moitié du doute serait restée. Si elle avait tout saisi les dix premiers jours puis plus rien, les tranches récentes seraient muettes et leurs jours garderaient leur doute entier — seuls les jours réellement suivis sont effacés. Une semaine calme, elle, ne pénalise plus que ses propres jours : c’est ce que la pondération a corrigé. Le simulateur (onglet précédent) rejoue chacun de ces cas.</Text>
              </View>
            </>
          )}
