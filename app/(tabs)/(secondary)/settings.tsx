      ...
      <SafeAreaView style={styles.safe} edges={['left', 'right', 'bottom']}>
        ...
        >
          <View style={styles.section}>
            ...
            <TouchableOpacity style={[styles.row, styles.rowLast]} activeOpacity={0.7} onPress={() => router.push('/(tabs)/(secondary)/categories')} accessibilityRole="button">
          ...
          {isAdmin && (
            <View style={styles.section}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={() => router.push('/(tabs)/(secondary)/admin')}
          ...
          <View style={styles.section}>
            ...
            <TouchableOpacity style={styles.row} activeOpacity={0.7} onPress={() => router.push('/(tabs)/(secondary)/theme')} accessibilityRole="button">
              <Ionicons name="moon-outline" size={22} color={COLORS.textSecondary} />
              <Text style={styles.rowLabel}>Thème</Text>
              <Ionicons name="chevron-forward" size={20} color={COLORS.textSecondary} />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.row, styles.rowLast]} activeOpacity={0.7} onPress={() => router.push('/(tabs)/(secondary)/about')} accessibilityRole="button">
