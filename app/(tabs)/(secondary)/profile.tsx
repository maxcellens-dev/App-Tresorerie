        ...
        <KeyboardAwareScrollView ref={scrollRef} style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ marginTop: 24 }}>
            <TouchableOpacity
              ...
              // signOut() navigue lui-même vers l'accueil, dans le bon ordre et sous voile.
              onPress={() => { signOut(); }}
              accessibilityRole="button"
            >
...
function makeStyles(c: any) {
  ...
  submitBtn: { backgroundColor: c.emerald, paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginBottom: 32 },
  ...
  passwordBtn: { backgroundColor: c.cardBorder, paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 8 },
  text: { color: c.text },
...
export default withDeferredMount(ProfileScreen);
