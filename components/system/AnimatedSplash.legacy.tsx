/**
 * ⚠️ VERSION PRÉCÉDENTE (anneau RelykaLoader), conservée volontairement pour pouvoir revenir en
 * arrière : si le splash « logo seul » ne convient pas, recopier ce fichier sur AnimatedSplash.tsx
 * (et retirer cet en-tête). N'est importée nulle part.
 *
