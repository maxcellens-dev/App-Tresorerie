...
import type { AmortRow } from '../lib/amortization';
...
export default function CreditCurve({ schedule, colors, principal }: Props) {
  ...
  return (
    <View onLayout={(e) => setWidth(e.nativeEvent.layout.width)}>
      ...
      {width > 0 && (
        <View style={[StyleSheet.absoluteFillObject as any, { flexDirection: 'row', paddingLeft: PAD_L, paddingRight: PAD_R, top: 18 }]} pointerEvents="box-none">
          {years.map((y) => (
