...
import { CATEGORY_ICON_GLOSSARY } from '../../lib/ui/categoryIcons';
          ...
          <ScrollView style={{ maxHeight: 360 }} showsVerticalScrollIndicator={false} contentContainerStyle={styles.grid}>
            {icons.map((name) => {
              ...
              return (
                <TouchableOpacity
                  key={name}
                  // Grille d'icônes : le nom de l'icône EST le libellé — rien d'autre ne distingue
                  // une cellule de sa voisine au lecteur d'écran.
