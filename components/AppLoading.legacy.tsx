/**
 * ⚠️ VERSION PRÉCÉDENTE (anneau RelykaLoader), conservée pour revert : recopier ce fichier sur
 * AppLoading.tsx (et retirer cet en-tête). Voir aussi AnimatedSplash.legacy.tsx. Importée nulle part.
 *
